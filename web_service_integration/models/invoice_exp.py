...
class AccountInvoice(models.Model):
    ...
    @api.multi
    def set_data_for_invoice_cambiaria_exp(self):
        ...
        dge = ET.SubElement(dem, "{" + xmlns + "}DatosGenerales", CodigoMoneda="GTQ", Exp="SI", FechaHoraEmision=fecha_emision, Tipo="FCAM")
        ...
        complemento2 = ET.SubElement(complementos, "{" + xmlns + "}Complemento", IDComplemento=str(randint(1,99999)), NombreComplemento="AbonosFacturaCambiariaExp", URIComplemento=cna)
    ...
    @api.multi
    def send_data_api_cambiaria_exp(self, xml_data=None):
